...
}).call(this,require("buffer").Buffer,"/node_modules/_codemirror-spell-checker@1.1.2@codemirror-spell-checker/node_modules/typo-js")
...
function toggleCodeBlock(editor) {
	...
	if(is_code === "single") {
		...
		for(var i = block_start; i <= block_end; i++) {
			cm.indentLine(i, "subtract"); // TODO: this doesn't getFile tracked in the history, so can't be undone :(
		}
		cm.focus();
	} else {
...
function SimpleMDE(options) {
	...
	if(options.toolbar === undefined) {
		...
		// Loop over the built in buttons, to getFile the preferred order
